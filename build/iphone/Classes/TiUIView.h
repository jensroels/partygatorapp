...
/**
 Base class for all Partygator views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Partygator view hierarchy (such as wrapped iOS UIViews) was touched.
